    ...
    <div class="paper">
        ...
        <?php
            if (isset($_GET["dng"])) {
                ...
                ' . $dng . ' 
                <a href="../../IMISS-System/PHP-Account-ChangePass/0changepass_reception.php" id="danger_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if (isset($_GET["scs"])) {
                $scs = $_GET["scs"];
                echo '<div class="success_msg" role="alert">
                ' . $scs . ' 
                <a href="../../IMISS-System/PHP-Account-ChangePass/0changepass_reception.php" id="success_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            } else if (isset($_GET["info"])) {
                $info = $_GET["info"];
                echo '<div class="info_msg" role="alert">
                ' . $info . ' 
                <a href="../../IMISS-System/PHP-Account-ChangePass/0changepass_reception.php" id="info_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if(isset($_GET["wng"])) {
                $wng = $_GET["wng"];
                echo '<div class="warning_msg" role="alert">
                ' . $wng . ' 
                <a href="../../IMISS-System/PHP-Account-ChangePass/0changepass_reception.php" id="warning_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            }
        ?>
        <div class="my_account">
            <div>
                ...
                <form action="../../IMISS-System/PHP-Account-ChangePass/0changepass_reception_function.php" method="POST">
                    <?php
                        $id = $_SESSION['id'];
                    ...
                    <div class="input_field">
                        <button type="submit" name="reception_submit" class="button_control">Save</button>
                        <a href="../../IMISS-System/PHP-Account-MyAccount/0myaccount_reception.php" class="button_control">Cancel</a>
                    </div>
                </form>
