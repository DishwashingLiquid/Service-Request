...
<body>
       ...
       <!--  <h2>armmc</h2> -->
        ...
        <?php if (isset($_SESSION["log_reception"])): ?>  
            ...
            <div class="accordion_one">
                <a class="accordion"><i class="fa-solid fa-user-plus"></i><span class="hidden">End-User</span></a>
                <div class="panel"> 
                    <a href="3end-user_approve.php"><i class="fa-solid fa-check"></i><span class="hidden">Approve</span></a>
                    <a href="3end-user.php"><i class="fa-solid fa-plus"></i><span class="hidden">Add New</span></a>
                </div>
            </div>
            ...
            <a href="7report.php"><i class="fa-solid fa-circle-check"></i><span class="hidden">Report</span></a>
    ...
    <script src="../IMISS-System/SCRIPT/accordion_open.js"></script>
</body>
</html>
