...
<body>
    ...
    <div class="paper">
        ...
        <div class="all_forms">
            ...
            <div> <!-- div for delete -->
                <h3>Delete Pending Request</h3>
                <form action="../../IMISS-System/PHP-Pending/actions_function.php" method="POST" autocomplete="off">
                    <?php
                    ...
                    <a href="../../IMISS-System/5pending.php" class="button_control">Cancel</a>
                </form>
            </div>
            <?php } else { ?>
            <div> <!-- div for edit -->
