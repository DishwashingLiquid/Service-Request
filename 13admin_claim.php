...
<head>
    ...
    <meta http-equiv="refresh" content="320;url=13admin_claim.php" />
    ...
    <div class="paper">
       ...
       <?php
            if (isset($_GET["dng"])) {
                ...
                ' . $dng . ' 
                <a href="../IMISS-System/13admin_claim.php" id="danger_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if (isset($_GET["scs"])) {
                $scs = $_GET["scs"];
                echo '<div class="success_msg" role="alert">
                ' . $scs . ' 
                <a href="../IMISS-System/13admin_claim.php" id="success_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            } else if (isset($_GET["info"])) {
                $info = $_GET["info"];
                echo '<div class="info_msg" role="alert">
                ' . $info . ' 
                <a href="../IMISS-System/13admin_claim.php" id="info_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if(isset($_GET["wng"])) {
                $wng = $_GET["wng"];
                echo '<div class="warning_msg" role="alert">
                ' . $wng . ' 
                <a href="../IMISS-System/13admin_claim.php" id="warning_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            }
        ?>
        <!-- CONTROLS ON THE TOP -->
        ...
        <table>
            ...
            <tbody>
                    ...
                    $sql = "SELECT  CONCAT(MONTH(a.date_requested), '-', YEAR(a.date_requested), '-', a.id) AS full_id, 
                                ...
                                a.id AS take_id, a.end_user_id, a.ict_equipment_code, a.description, a.status, a.admin_id,
                ...
                <tr class="table_row">
                    ...
                    <td> 
                        <a href="../IMISS-System/PHP-Dashboard-Imiss/claim_request.php?id=<?php echo $row["take_id"] ?>" class="button_control button_action">claim</a>
                    </td> 
                </tr>
