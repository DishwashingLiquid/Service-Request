<?php
    ...
    if(isset($_POST["edit_submit"])) { 
        ...
        $sql = "UPDATE `equipment-list-server` SET
                `area` = '$area',
                `brand` = '$brand',
                `model` = '$model',
        ...
        if($result) {
            header("Location: ../../../../IMISS-System/PHP-Inventory/actions_server.php?scs=Updated successfully.");
        } else {
        ...
        <div class="all_forms">
            <div> <!-- div for edit --> 
                ...
                <form action="" method="post" autocomplete="off">  
                    ...
                    <div class="input_field">
                        <input type="text" name="application" id="application" value="<?php echo $row['application']?>" required>
                        <label for="application">Application:</label>
                    </div>
                    <div class="input_field">
                        <textarea name="specification" id="specification" style="height: 11.2vh;" required><?php echo $row['specification']?></textarea> 
                    ...
                    <a href="../../IMISS-System/PHP-Inventory/actions_server.php" class="button_control">Cancel</a> 
                </form>
            </div>  
        </div>
    </div>
