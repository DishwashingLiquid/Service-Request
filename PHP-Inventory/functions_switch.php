<?php
    ...
    if(isset($_POST["edit_submit"])){
        ...
        $sql = "UPDATE `equipment-list-switch` SET
                `area` = '$area',
                `brand` = '$brand',
                `model` = '$model',
        ...
        if($result) {
            header("Location: ../../../../IMISS-System/PHP-Inventory/actions_switch.php?scs=Updated successfully.");
        } else {
        ...
        <div class="all_forms">
            <div> <!-- div for edit --> 
                ...
                <form action="" method="post" autocomplete="off">  
                    ...
                    <div class="input_field">
                        <input type="text" name="no_of_ports" id="no_of_ports" value="<?php echo $row['no_of_ports']?>" required>
                    ...
                    <a href="../../IMISS-System/PHP-Inventory/actions_switch.php" class="button_control">Cancel</a> 
                </form>
            </div>  
