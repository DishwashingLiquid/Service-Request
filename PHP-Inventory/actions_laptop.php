<?php
    ...
    if(isset($_POST["add_submit"])) {
        ...
        $sql = "INSERT INTO `equipment-list-laptop`
                    (`area`, `brand`, `model`, `ms_office`, `os`, `updated_by`)
                VALUES
                    ('$area', '$brand', '$model', '$ms_office', '$os', '$updated_by')
                ";
    ...
    if($result) {
        header("Location: ../../../../IMISS-System/PHP-Inventory/actions_laptop.php?scs=Added successfully.");
    } else {
    ...
    <div class="paper">
        ...
        <?php
            if (isset($_GET["dng"])) {
                ...
                ' . $dng . '
                <a href="../../IMISS-System/PHP-Inventory/actions_laptop.php" id="danger_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            } else if(isset($_GET["scs"])) {
                $scs = $_GET["scs"];
                echo '<div class="success_msg" role="alert">
                ' . $scs . '
                <a href="../../IMISS-System/PHP-Inventory/actions_laptop.php" id="success_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            } else if (isset($_GET["info"])) {
                $info = $_GET["info"];
                echo '<div class="info_msg" role="alert">
                ' . $info . ' 
                <a href="../../IMISS-System/PHP-Inventory/actions_laptop.php" id="info_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if(isset($_GET["wng"])) {
                $wng = $_GET["wng"];
                echo '<div class="warning_msg" role="alert">
                ' . $wng . ' 
                <a href="../../IMISS-System/PHP-Inventory/actions_laptop.php" id="warning_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            }
        ?>
        <!-- CONTROLS ON THE TOP -->
        ...
        <form action="" method="POST" autocomplete="off">
            <div class="all_forms" style="margin-top: 0vh">
                <div class="inventory_spec">
                    <?php 
                        ...
                        $sql = "SELECT MAX(id) as max_id FROM `equipment-list-laptop`";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($result);
                        $next_id = $row['max_id'] + 1; /* to get next auto-id */
                    ?>
                    <div class="input_field top_id">
                        <input type="text" name="next_id" id="next_id" value="<?php echo 'LTP-', $today, '-', $next_id ?>" disabled>
                    ...
                    <div class="input_field">
                        <input type="text" name="ms_office" id="ms_office" required>
            ...
            <div class="inventory_controls" style="padding-top: 0vh;">
        ...
        <form action="" method="POST">
            ...
            <?php 
                ...
                <?php } ?>
        <!-- TABLE DATA -->
        <div class="container" style="height: 56.9vh;">
        <table>
            ...
            <tbody>
                    <?php
                        $sql = "SELECT CONCAT(id_name, '-', id_year, '-', id) AS full_id, 
                                id, area, brand, model, ms_office, os, status, updated_by
                    ...
                    ?>
                <tr class="table_row"> 
                    <td><a href="../../IMISS-System/PHP-Inventory/functions_laptop.php?id=<?php echo $row['id'] ?>"><?php echo $row["full_id"]?></a></td>
        ...
        <div class="table_control">
            <?php
                $sql = "SELECT * FROM `equipment-list-laptop`
                        WHERE status = 'Active'";
