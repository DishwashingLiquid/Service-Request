<?php
    ...
    if(isset($_POST["edit_submit"])){ 
        ...
        $sql = "UPDATE `equipment-list-scanner` SET
                `area` = '$area',
                `brand` = '$brand',
                `model` = '$model',
                `type` = '$type',
        ...
        if($result) {
            header("Location: ../../../../IMISS-System/PHP-Inventory/actions_scanner.php?scs=Updated successfully.");
        } else {
        ...
        <div class="all_forms">
            <div> <!-- div for edit --> 
                ...
                <form action="" method="post" autocomplete="off">  
                    ...
                    <a href="../../IMISS-System/PHP-Inventory/actions_scanner.php" class="button_control">Cancel</a> 
                </form>
            </div>  
        </div>
    </div>
