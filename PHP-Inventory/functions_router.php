<?php
    ...
    if(isset($_POST["edit_submit"])){
        ...
        $sql = "UPDATE `equipment-list-router` SET
                `area` = '$area',
                `brand` = '$brand',
                `model` = '$model',
        ...
        if($result) {
            header("Location: ../../../../IMISS-System/PHP-Inventory/actions_router.php?scs=Updated successfully.");
        } else {
        ...
        <div class="all_forms">
            <div> <!-- div for edit --> 
                ...
                <form action="" method="post" autocomplete="off">  
                    ...
                    <div class="input_field">
                        <input type="text" name="mac_address" id="mac_address" value="<?php echo $row['mac_address']?>" required>
                    ...
                    <a href="../../IMISS-System/PHP-Inventory/actions_router.php" class="button_control">Cancel</a> 
                </form>
            </div>  
        </div>
    </div>
