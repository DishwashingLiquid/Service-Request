<?php
    ...
    if (isset($_POST["send"])) { /* used send instead submit because of PHP mailer */ 
    ...
    if ($result) {
        header("Location: ../../IMISS-System/15admin_pending.php?scs=Request resolved successfully.");
    } else {
            ...
            <div>
                ...
                <?php
                    $sql = "SELECT CONCAT(a.date_requested, ' : ', a.time_requested) AS datetime_requested,
                                ...
                                a.id, a.end_user_id, a.ict_equipment_code, a.description, a.assessment, a.remarks, a.service_rendered, a.type_of_service, 
                                a.ict_component, a.ict_component_spec,
                                b.id, b.email, CONCAT(b.end_user_fname, ' ', b.end_user_mname, ' ', b.end_user_lname) AS full_user,
                ...
                <a href="../../IMISS-System/15admin_pending.php" class="button_control">Cancel</a> 
                </form>
