...
<head>
    ...
    <meta http-equiv="refresh" content="320;url=5pending.php"/>
    ...
    <div class="paper">
        ...
        <?php
            if (isset($_GET["dng"])) {
                ...
                ' . $dng . ' 
                <a href="../IMISS-System/5pending.php" id="danger_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if (isset($_GET["scs"])) {
                $scs = $_GET["scs"];
                echo '<div class="success_msg" role="alert">
                ' . $scs . ' 
                <a href="../IMISS-System/5pending.php" id="success_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            } else if (isset($_GET["info"])) {
                $info = $_GET["info"];
                echo '<div class="info_msg" role="alert">
                ' . $info . ' 
                <a href="../IMISS-System/5pending.php" id="info_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if(isset($_GET["wng"])) {
                $wng = $_GET["wng"];
                echo '<div class="warning_msg" role="alert">
                ' . $wng . ' 
                <a href="../IMISS-System/5pending.php" id="warning_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            }
        ?>
        <!-- CONTROLS ON THE TOP -->
        <form action="../IMISS-System/PHP-Pending/actions.php" method="POST"> <!-- used form to add, delete and edit with checkbox work --> 
        <div class="controls">
            ...
            <table>
                ...
                <tbody>
                        ...
                        $sql = "SELECT CONCAT(MONTH(a.date_requested), '-', YEAR(a.date_requested), '-', a.id) AS full_id, 
                                    ...
                                    a.id AS take_id, a.ict_equipment_code, a.description, a.type_of_service, a.ict_component, a.ict_component_spec, 
                                    a.assessment, a.remarks, a.service_rendered, a.end_user_id, a.admin_id, a.status, a.updated_by,
                    ...
                    <tr class="table_row"> 
                        ...
                        <td><?php echo $row["datetime_pending"]; ?></td> 
