...
<head>
    ...
    <meta http-equiv="refresh" content="320;url=3end-user.php"/>
...
<body>
    ...
    <div class="section">
    <div class="paper">
        <div class="titlebar">add new end-user</div>
        ...
        <?php
            if (isset($_GET["dng"])) {
                ...
                ' . $dng . ' 
                <a href="../IMISS-System/3end-user.php" id="danger_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if (isset($_GET["scs"])) {
                $scs = $_GET["scs"];
                echo '<div class="success_msg" role="alert">
                ' . $scs . ' 
                <a href="../IMISS-System/3end-user.php" id="success_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            } else if (isset($_GET["info"])) {
                $info = $_GET["info"];
                echo '<div class="info_msg" role="alert">
                ' . $info . ' 
                <a href="../IMISS-System/3end-user.php" id="info_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if(isset($_GET["wng"])) {
                $wng = $_GET["wng"];
                echo '<div class="warning_msg" role="alert">
                ' . $wng . ' 
                <a href="../IMISS-System/3end-user.php" id="warning_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            }
        ?>
        <!-- CONTROLS ON THE TOP -->
        <form action="../IMISS-System/PHP-End-User/actions.php" method="POST"> <!-- used form to add, delete and edit with checkbox work -->
        <div class="controls"> 
        ...
        <table>
            ...
            <tbody>
                    <?php
                    $sql = "SELECT CONCAT(id_name, id) AS full_id, 
                                id, division, area, end_user_fname, end_user_mname, 
