    ...
    <div class="paper">
        ...
        <?php
            if (isset($_GET["dng"])) {
                ...
                ' . $dng . ' 
                <a href="../../IMISS-System/PHP-Account-MyAccount/0myaccount_reception.php" id="danger_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if (isset($_GET["scs"])) {
                $scs = $_GET["scs"];
                echo '<div class="success_msg" role="alert">
                ' . $scs . ' 
                <a href="../../IMISS-System/PHP-Account-MyAccount/0myaccount_reception.php" id="success_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            } else if (isset($_GET["info"])) {
                $info = $_GET["info"];
                echo '<div class="info_msg" role="alert">
                ' . $info . ' 
                <a href="../../IMISS-System/PHP-Account-MyAccount/0myaccount_reception.php" id="info_close"><i class="fa-solid fa-xmark"></i></a>
                </div>'; 
            } else if(isset($_GET["wng"])) {
                $wng = $_GET["wng"];
                echo '<div class="warning_msg" role="alert">
                ' . $wng . ' 
                <a href="../../IMISS-System/PHP-Account-MyAccount/0myaccount_reception.php" id="warning_close"><i class="fa-solid fa-xmark"></i></a>
                </div>';
            }
        ?>
        <div class="my_account">
            <div>
                <p class="account_name"><?php echo $_SESSION['reception_fname'], " ", $_SESSION['reception_mname'], " ", $_SESSION['reception_lname'];?></p>
                <p>Reception</p> 
            <form action="" method="post" autocomplete="off"> 
                    <div class="input_field">
                        <input type="text" name="id" value="<?php echo "REC-", $_SESSION['id'] ?>" disabled>
                    ...
                    <?php
                        $id = $_SESSION['id'];
                        $sql = "SELECT password FROM `reception-list`
                                WHERE id = $id";
            ...
            <div class="input_field">
                <a href="../../IMISS-System/PHP-Account-ChangePass/0changepass_reception.php" class="button_control">Change Password</a>
            </div>
            ...
            <a href="../../IMISS-System/1admin.php" class="button_control">Cancel</a>
            </div>
    </div>
    </div>
    </div> 
